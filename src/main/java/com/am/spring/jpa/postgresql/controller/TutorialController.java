...
import com.am.spring.jpa.postgresql.repository.TutorialRepository;
...
public class TutorialController {
	...
	@GetMapping("/tutorials")
	public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(required = false) String description) {
		try {
			List<Tutorial> tutorials = new ArrayList<Tutorial>();
